...
- [x] Release: ordinary packaged notices, no semantic license/SBOM gate or
  ...
  standalone upgrades. Platform tar replaces the custom writer. The archive
  shape remains consumable by existing standalone upgraders.
- [x] Decisions: derive observations from accepted ledgers; persist human actions,
...
- [x] Bundles: the verified private snapshot is execution authority. Stop repeated
...
- [x] Process: shrink repository rules and remove duplicated generic process
