# Candidate evidence — not release certification
...
The native candidate artifacts remain downloadable from the CI run. Resume with
those exact bytes once Claude authentication is usable; do not rebuild a
lookalike or treat historical authenticated runs as proof of this candidate.
